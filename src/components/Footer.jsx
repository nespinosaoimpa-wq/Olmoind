...
import { Instagram, Facebook, MessageCircle, Truck, CreditCard } from 'lucide-react';
    ...
    return (
        <footer style={{
            ...
            <div className="container" style={{
                ...
                <div>
                    ...
                    <div style={{ display: 'flex', gap: '25px' }}>
                        <a href="#" style={{ color: 'var(--accent)' }}><Instagram size={22} /></a>
                        <a href="#" style={{ color: 'var(--accent)' }}><Facebook size={22} /></a>
                        <a href="#" style={{ color: 'var(--accent)' }}><MessageCircle size={22} /></a>
                    </div>
                </div>

                {/* Categories */}
                <div>
                    <h4 style={{ fontSize: '12px', fontWeight: '900', marginBottom: '30px', letterSpacing: '3px', color: 'var(--accent)' }}>EXPLORAR</h4>
                    <ul style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
                        ...
                        <li><a href="/?admin=true" style={{ color: 'var(--accent)', fontSize: '11px', marginTop: '15px', display: 'block', fontWeight: '800' }}>ADMIN PANEL</a></li>
                    </ul>
                </div>

                {/* Contact & Help */}
                <div>
                    <h4 style={{ fontSize: '12px', fontWeight: '900', marginBottom: '30px', letterSpacing: '3px', color: 'var(--accent)' }}>CONTACTO</h4>
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '20px', color: 'var(--text-secondary)', fontSize: '14px', fontWeight: '600' }}>
                        ...
                        <p>EMAIL: INFO@OLMOIND.COM</p>
                    </div>
                </div>

                {/* Methods Badge */}
                <div>
                    <h4 style={{ fontSize: '12px', fontWeight: '900', marginBottom: '30px', letterSpacing: '3px', color: 'var(--accent)' }}>SISTEMA</h4>
            ...
            <div style={{
                ...
                <p style={{ color: 'var(--accent)', fontSize: '10px', fontWeight: '800', letterSpacing: '2px' }}>
